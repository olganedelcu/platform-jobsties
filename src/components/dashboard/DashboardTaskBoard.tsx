      ...
      <CardContent className="p-4 pt-0">
        {allInProgressTasks.length > 0 ? (
          <>
                  ...
                  <div key={task.id} className="flex items-start gap-2 p-2 bg-green-50 rounded-md border border-green-100">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-1 mt-1 flex-wrap">
                        <Badge 
                          variant="outline" 
                          className="text-xs bg-orange-50 text-orange-700 border-orange-200 px-1 py-0"
                        >
                          In Progress
                        </Badge>
                        {task.source === 'coach' && (
            ...
            <div className="mt-3 pt-3 border-t border-gray-200">
              <Button 
                ...
                variant="ghost"
                size="sm"
                className="w-full text-green-600 hover:text-green-700 hover:bg-green-50 text-sm"
              >
                View Task Board
          ...
          <div className="text-center py-6">
            ...
            <div className="text-xs text-gray-500 mb-3">Start working on your tasks to see them here</div>
            <Button 
              onClick={handleViewAllTasks} 
              size="sm"
