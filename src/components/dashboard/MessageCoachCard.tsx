      ...
      <CardContent className="p-4">
        ...
        {!loading && recentConversations.length > 0 ? (
          <>
            ...
            <div className="mt-3 pt-3 border-t border-gray-200 space-y-2">
              <Button 
                ...
                variant="ghost"
                size="sm"
                className="w-full text-indigo-600 hover:text-indigo-700 hover:bg-indigo-50 text-sm"
              >
                View All Messages
              </Button>
              <Button 
          ...
          <div className="text-center py-6">
            ...
            <div className="text-xs text-gray-500 mb-3">Start a conversation with your coach</div>
            <Button 
              onClick={handleMessageCoach}
              size="sm"
