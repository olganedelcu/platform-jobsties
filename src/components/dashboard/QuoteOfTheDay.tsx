        ...
        <div className="flex items-start space-x-4">
          ...
          <div className="flex-1 space-y-3">
            ...
            <div className="relative">
              <div className="absolute -left-2 -top-1 text-5xl text-purple-300/50 font-serif">"</div>
              <blockquote className="text-gray-800 text-xl leading-relaxed font-medium pl-8 pr-6 italic">
                {todaysQuote.text}
              </blockquote>
              <div className="absolute -right-2 -bottom-4 text-5xl text-purple-300/50 font-serif">"</div>
            </div>
