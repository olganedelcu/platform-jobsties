...
const RecommendationCard = ({ 
  ...
  // Extract just the region/country from timezone (e.g., "Europe" from "Europe/London")
      ...
      <div className="flex items-start justify-between mb-3">
        <div className="flex-1">
          ...
          <div className="flex items-center gap-2 text-xs text-gray-500">
            ...
            <span>Added {format(new Date(recommendation.created_at), 'MMM dd, yyyy')} ({getTimeZoneRegion(userTimeZone)})</span>
          </div>
        </div>
